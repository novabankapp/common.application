...
// respectively. Depending on the requirements, this function can be used only
...
// DecryptString returns a decrypted byte version of the given string data
...
// DecryptByte returns a decrypted byte version of the given byte data using
